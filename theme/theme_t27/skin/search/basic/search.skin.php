...
<div class="hidden-sm hidden-xs mt80"></div>
<div class="hidden-lg hidden-md mt60"></div>
<div class="container mb80">
	<div class="row">
		<div class="col-md-12">
			<div class="center-heading">
				<h2 class="kos4">SEARCH</h2>
	...
	<div class="container" style="padding-left:10px;padding-right:10px;">
		<div class="row">
			...
			<div class="col-md-3 " style="padding: 0px 5px;">
				...
				<span class="sch_wr">
					<input type="text" name="stx" value="<?php echo $text_stx ?>" id="stx" required class="frm_input">
				</span>
			</div>
	...
	<div id="sch_result">
		...
		<?php if ($stx && $board_count) { ?><section class="sch_res_list container no-padding"><?php }  ?>
		<?php
		$k=0;
