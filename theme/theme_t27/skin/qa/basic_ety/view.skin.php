...
?>
<style>
a.btn_b01.btn{padding:6px 20px;}
a.btn_b02,.btn_b02 {display:inline-block;background:#3498db;padding:7px 12px;color:#fff;text-decoration:none;border:0;vertical-align:middle;}
...
<article id="bo_v">
    <header>
        <h2 id="bo_v_title" class="ko" style="margin:0px;">
            <?php
    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="bo_v_com">
	            ...
	            <?php if ($write_href) { ?>
				<li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
	        	...
	        	<li>
	        		...
	        		<ul class="more_opt">
	        			<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn btn_1" title="수정">수정</a></li><?php } ?>
	            		<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn btn_1" onclick="del(this.href); return false;" title="삭제">삭제</a></li><?php } ?>
	        		</ul>
	        	</li>
                <?php } ?>
	        </ul>
