...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
					...
					<div id="bo_list" style="overflow-x: auto;white-space: nowrap;">
						...
						<div class="bo_fx">
							<ul class="btn_bo_user">
								...
								<?php if ($write_href) { ?>
								<li><li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 문의등록</a></li><?php } ?>
							</ul>
						</div>
						</form>
					</div>
