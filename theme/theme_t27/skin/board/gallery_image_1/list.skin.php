									 ...
									 ?>
										<div class="col-xs-12 col-sm-6 <?php echo $cols;?>" style='margin-bottom:30px;'>
											...
											<div class="hover_container">
												...
												<div class="overlay">
													<div class="hover_text ko f14">

														<div class="f14"><?php echo $list[$i]['subject']?></div>
														<div>
															<small>조회 <?php echo $list[$i]['wr_hit']?></small>
															<small>추천 <?php echo $list[$i]['wr_good']?></small>
															<small>비추천 <?php echo $list[$i]['wr_nogood']?></small>
														</div>
