...
.item-img-overlay span {
    background: url('<?php echo G5_THEME_URL?>/img/plus.png') no-repeat center center rgba(0, 0, 0, 0.7);
}
</style>
						  ...
						  <section class="wrapper">
								<div class="row">
									<?php for ($i=0; $i<count($list); $i++) {
									 ...
									 ?>
										<div class="col-xs-12 col-sm-6 <?php echo $cols;?>" style='margin-bottom:30px;'>
											<!-- 체크박스 -->
											...
											<div class="item-img-wrap">
												...
												<?php } else {
													...
													if($thumb['src']) {
														$img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" class="hover_images" >';
													} else {
											...
											<div class="full_2_subject ko f14">
												<strong><?php echo $list[$i]['subject']?></strong>
												<ul>
													<li class="f12"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $list[$i]['name']?></li>
													<li class="f12"><?php echo $list[$i]['datetime2']?></li>
													<li class="f12"><i class="fa fa-line-chart" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit']?></li>
													<li class="f12"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good']?> <i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood']?></li>
												</ul>
											</div>
										</div>
