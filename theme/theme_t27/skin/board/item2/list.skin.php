										...
										<div class="col-xs-12 col-sm-6 <?php echo $cols;?>" style='margin-bottom:30px;'>
											...
											<div class="row">
												<div class="col-md-12">
														...
														<table class="table-latest ko" >
															<tr>
																<td colspan="2"><?php echo $list[$i]['subject'];?></td>
															</tr>
															<?php 
																if($list[$i]['wr_1']){ 
															...
															<?php } ?>
															<tr>
																<td colspan="2" style="background:#ffffff;padding:10px 0px;margin:10px 0px;border:1px solid #fff;">
																	<a href="<?php echo $list[$i]['href'] ?>" class="btn btn-theme-dark ko">바로가기</a>
																</td>
															</tr>
														</table>
