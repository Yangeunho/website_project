					...
					<div id="bo_gall" style="width:<?php echo $width; ?>">
					  ...
					  <section class="wrapper">
									...
									<?php for ($i=0; $i<count($list); $i++) {
									 ...
									 ?>
										<div class="col-xs-12 col-md-6 col-sm-6 col-xs-12 mb30 <?php echo $cols;?>">
											...
											<div class="hover ehover1">
												...
												<div class="overlay">
													<h2 class="ko" style="
														position: relative;
														font-size: 17px;
														font-weight: 0;													line-height: 2;
														padding: 10px;
														margin-top: 20px;
														background: rgba(0, 0, 0, 0.6);
													">
													
													<?php echo $list[$i]['subject']?></h2>
													
													<button type="button" class="info ko" data-toggle="modal" data-target="#modal1" ONCLICK="location.href='<?php echo $list[$i]['href'] ?>'">더보기</button>
