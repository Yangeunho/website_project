...
// 여분필드 추가 시작(번호/제목/나이/연락처/카카오톡/글쓴이/날짜/조회) 8개
$colspan = 7;
// 여분필드 추가 끝
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap SF_board">
        ...
        <tr>
            ...
            <th scope="col">제목</th>
			<!-- 여분필드 추가 시작 -->
            <th scope="col">수집장소</th>
            <th scope="col">수집물량</th>
            <!-- 여분필드 추가 끝 -->
            <th scope="col">글쓴이</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*15) : '10'; ?>px">
            ...
            <td class="td_num" style="width: 60px;"><?php echo $list[$i]['wr_hit'] ?></td>
            <?php if ($is_good) { ?><td class="td_num" style="width: 60px;"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
            <?php if ($is_nogood) { ?><td class="td_num" style="width: 80px;"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
            <td class="td_datetime" style="width: 70px;"><?php echo $list[$i]['datetime2'] ?></td>
