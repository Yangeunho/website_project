...
<section id="bo_w">
    ...
    <p>
        <tr>
            <!-- <th scope="row"><label for="wr_1">수집장소:</label></th> -->
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input" size="60" placeholder="수집장소"></td>
        </tr>
	</P>
	<p>
		<tr>
            <!-- <th scope="row"><label for="wr_2">수집물량: </label></th> -->
            <td><input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input" size="60" placeholder="수집물량"></td>
        </tr>
    </p>
    <!-- 여분필드 추가 끝 -->
    <div class="write_div">
