...
<style>
.main_two_title{
color:#111;padding:15px 0px;
font-family:SCDream4,sans-serif;
font-style:normal;font-weight:400;
font-size:22px;margin-left:15px
}

.two_more{position:absolute;top:15px;right:10px;font-size:22px}.two_more:hover{transform:rotate(180deg)}
</style>

<div class="row">
	<div class="col-md-12 main_two_title">
		<?php echo $bo_subject?>
		
	</div>
</div>
<a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>" class="two_more"><span class="sound_only"><?php echo $bo_subject ?></span><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only"> 더보기</span></a>
<div class="lat_list">
    <ul>
