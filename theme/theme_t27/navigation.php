                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 text-right">
                        <ul class="list-inline top-dark-right">                      
							...
							<li class="ko_gul"><a href="<?php echo G5_URL ?>/qa"> 1:1문의</a></li>
        ...
        <div class="navbar navbar-default navbar-static-top yamm sticky" role="navigation">
            <div class="container">
                <div class="navbar-header">
					...
					<!-- logo -->
					<a href="<?php echo G5_URL?>"><img src="<?php echo G5_THEME_URL?>/img/logo.gif" class="img-responsive" style="width:200px;"></a>
