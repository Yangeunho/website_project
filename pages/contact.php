    ...
    <head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 margin30">
                    ...
                    <div class="form-contact">
                       ...
                       <form name="sentMessage" action="contact_update.php" id="contactForm" method="post" novalidate>
							...
							<?php
							// 개인정보처리방침
							$sql = "select co_content from {$g5['content_table']} where co_id = 'privacy'";
							$agree = sql_fetch($sql);
							echo strip_tags($agree['co_content'],"<p><br>");
							?>
							</P>
							</div>
							...
							<div class="row control-group">
								<div class="form-group col-xs-12 controls">
									<a href="<?php echo G5_URL?>/content/privacy" target="_blank" class="btn btn-xs ko" style="color:#000">개인정보처리방침</a>
									<input type="checkbox" class="" name="agree_1" value="1"> 동의
								</div>
							</div>
							...
							<?php
							// 서비스이용약관
							$sql = "select co_content from {$g5['content_table']} where co_id = 'provision'";
							$agree1 = sql_fetch($sql);
							echo strip_tags($agree1['co_content'],"<p><br>");
							?>
							</P>
							</div>
							<div class="row control-group">
								<div class="form-group col-xs-12 controls">
									<a href="<?php echo G5_URL?>/content/privacy" target="_blank" class="btn btn-xs ko" style="color:#000">서비스이용약관</a>
									<input type="checkbox" class="" name="agree_2" value="1"> 동의
								</div>
							</div>
                ...
                <div class="col-md-4">
					<h4>ADDRESS</h4>
					<ul class="list-unstyled contact kn">
