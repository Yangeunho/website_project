								...
								<div class="col-lg-12 mar-bot30">
									<div class="responsive-slider" data-spy="responsive-slider" data-autoplay="true">
										<div class="slides" data-group="slides">
											<ul>
												<!-- 가로 크기를 1000px 이상의 이미지를 사용해주세요. -->
												<div class="slide-body" data-group="slide">
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1200x450" style="max-width:100%; width:100%; padding:0px;margin:0px;"></li>
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1200x450" style="max-width:100%;"></li>
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1200x450" style="max-width:100%;"></li>
