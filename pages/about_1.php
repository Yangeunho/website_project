			...
			<!-- Content Row -->
				<div class="row about01">
					<div class="col-md-3 text-center">
						<img src="https://via.placeholder.com/238x361">
					</div>
					...
					<div class="row">
						...
						<p class="kn" style="padding-top:60px;">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title ko">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                        <i class="fa fa-desktop"></i> <strong>반응형 홈페이지</strong>
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body kn">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title ko">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                        <i class="fa fa-crop"></i> <strong>템플릿 </strong>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title ko">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                        <i class="fa fa-cogs"></i> <strong>템플릿 사용법</strong>
                                    </a>
                                </h4>
                            </div>
			...
			<div class="row">
				<div class="col-md-12 no-padding">
					<div class="owl-carousel owl-theme">
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/1.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/2.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/3.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/4.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/5.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/6.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/7.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/8.png"></div>
						<div class="item"><img src="<?php echo G5_URL?>/pages/img/03/9.png"></div>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="intro-text-1 light">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="<?php echo G5_URL?>/board_qa" target="_blank" class="btn border-theme btn-lg ko">바로가기</a>
                    </div>
                </div>
            </div>
        </div> <!--intro text end-->
