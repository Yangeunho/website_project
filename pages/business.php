        ...
        <div class="container">
            <div class="row" style="overflow: hidden;">
                ...
                <div class="col-sm-9">
										...
										<div class="slides" data-group="slides">
											<ul>
												...
												<div class="slide-body" data-group="slide">
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1000x500" width="100%" height="350"/></li>
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1000x500" width="100%" height="350"/></li>
													<li><img alt="" class="img-responsive" src="https://via.placeholder.com/1000x500" width="100%" height="350"/></li>
					...
					<div class="row">
						<div class="col-md-12">
							<h3 class="ko f20"><strong>주요사업안내</strong></h3>
						</div>
					</div>
