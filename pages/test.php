							...
							<div id="work-carousel" class="owl-carousel owl-theme owl-spaced">
								<div>
									<div class="item-img-wrap ">
										<img src="https://via.placeholder.com/500x400" class="img-responsive" alt="workimg"><!-- 썸네일 -->
										<div class="item-img-overlay">
											<a href="https://via.placeholder.com/500x400" class="show-image"><!-- 실제 보여줄 이미지 -->
												<span></span>
											</a>
										</div>
									</div> <!--item img wrap-->
									<div class="work-desc">
										...
										<span class="kn">이미지 관련된 컨덴츠 내용</span>
									</div><!--work desc-->
								</div><!--owl item-->
								<div> 
									<div class="item-img-wrap ">
